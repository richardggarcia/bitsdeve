        ...
        <section id="sobre-nosotros" className="py-20 md:py-32 px-6 relative overflow-hidden bg-white">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-stretch">
                    {/* Philosophy Card */}
                    <div className="premium-card p-8 rounded-2xl card-hover flex flex-col" style={{ background: 'linear-gradient(145deg, #ffffff 0%, #F8FAFC 100%)', borderColor: 'rgba(51, 65, 85, 0.15)' }}>
